...
class CareerRecommendationEngine:
    ...
    def generate_recommendations(
        ...
        4. Ranks careers descending by compatibility score.
        5. Deduplicates on career_id for Top-K extraction.
        6. Extracts Top 1, Top 3, Top 5, Top 10 recommendations.
        """
        ...
        # 4. Sort descending by compatibility probability, then ability & interest match
        catalogue_sorted = catalogue_scored.sort_values(
            by=['probability', 'ability_match', 'interest_match'],
            ascending=[False, False, False]
        )

        # 5. Deduplicate unique careers for Top-K extraction
