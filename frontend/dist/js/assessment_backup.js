/* assessment.js â€” Multi-step AI Career Assessment */
    ...
    <div class="stepper-wrapper">
      ${labels.map((label, i) => `
        <div class="step-item ${i + 1 < currentStep ? 'completed' : i + 1 === currentStep ? 'active' : ''}">
          <div class="step-dot">${i + 1 < currentStep ? 'âœ“' : i + 1}</div>
...
// â”€â”€ STEP 1 DYNAMIC FIELDS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ STEP 2: SUBJECT MARKS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ STEP 3: APTITUDE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
async function loadAptitudeQuestions() {
  ...
  try {
    ...
    aptitudeQuestions = [
      ...
      { id:4, question_text:'Speed of light in vacuum?', option_a:'3Ã—10â¸ m/s', option_b:'3Ã—10â¶ m/s', option_c:'1.5Ã—10â¸ m/s', option_d:'3Ã—10â¹ m/s', correct_answer:'A', category:'Physics', difficulty:'Easy' },
      { id:5, question_text:'Worst-case time complexity of QuickSort?', option_a:'O(N log N)', option_b:'O(NÂ²)', option_c:'O(N)', option_d:'O(log N)', correct_answer:'B', category:'Algorithms', difficulty:'Hard' },
    ];
  }
...
function renderAptitudeQuestions() {
  ...
  container.innerHTML = aptitudeQuestions.map((q, qi) => `
    <div class="card mb-3" style="border-left:3px solid var(--primary)">
      <div class="q-counter">Question ${qi+1} of ${aptitudeQuestions.length} Â· <span class="badge badge-primary">${q.category}</span> Â· <span class="badge badge-amber">${q.difficulty}</span></div>
...
// â”€â”€ STEP 4: PSYCHOMETRIC â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ STEP 5: INTEREST PAIRS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ STEP 6: SKILLS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ STEP 7: CERTS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function addCert() {
  ...
  row.innerHTML = `
    ...
    <button class="btn btn-danger btn-sm" onclick="removeCert(${i})" style="height:40px;align-self:flex-end">âœ•</button>
  `;
...
// â”€â”€ STEP 8: PROJECTS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function addProj() {
  ...
  row.innerHTML = `
    ...
    <button class="btn btn-danger btn-sm" onclick="removeProj(${i})" style="height:40px;align-self:flex-end">âœ•</button>
  `;
  container.appendChild(row);
}
...
// â”€â”€ SUBMIT ASSESSMENT â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
async function submitAssessment() {
  saveCerts();
  saveProjects();

  UI.setLoading('submit-assessment-btn', true, 'â³ Submitting...', 'ðŸ¤– Get AI Career Prediction â†’');
  currentStep = 9;
  updateStepUI();
  window.scrollTo(0,0);
  ...
  try {
    ...
    renderResults({
      top5_careers: [
        { rank:1, career:'AI / ML Engineer', confidence:92, why:['Strong Aptitude Score','Technical Interests','High Logical Reasoning'], salary:'$95Kâ€“$160K', degree:'BTech CS / MTech AI', companies:'Google, Microsoft, Amazon', growth:'+28% annually', certifications:'TensorFlow, AWS ML Specialty' },
        { rank:2, career:'Data Scientist', confidence:87, why:['Analytical Thinking','Interest in Research','Strong Math Foundation'], salary:'$90Kâ€“$145K', degree:'BTech / MSc Statistics', companies:'Netflix, Uber, Meta', growth:'+25% annually', certifications:'IBM Data Science, Google Data Analytics' },
        { rank:3, career:'Full-Stack Developer', confidence:82, why:['Programming Skills','Project Building','Problem Solving'], salary:'$80Kâ€“$130K', degree:'BTech CS / BCA', companies:'Infosys, TCS, Startup', growth:'+22% annually', certifications:'AWS, React Certified' },
        { rank:4, career:'Cloud Architect', confidence:76, why:['Technology Interest','Systems Thinking','Strong Aptitude'], salary:'$110Kâ€“$165K', degree:'BTech + AWS/Azure Certs', companies:'Amazon, Google, Microsoft', growth:'+24% annually', certifications:'AWS Solutions Architect' },
        { rank:5, career:'Cyber Security Analyst', confidence:71, why:['Analytical Mindset','Problem Solving','Attention to Detail'], salary:'$85Kâ€“$140K', degree:'BTech CS / B.Sc IT', companies:'CrowdStrike, Palo Alto, IBM', growth:'+20% annually', certifications:'CISSP, CEH, CompTIA Security+' },
      ],
    ...
    ${top5.map((c, idx) => `
      <div class="career-card ${idx === 0 ? 'top-match' : ''} mb-3">
        ...
        <div class="flex gap-1 wrap mb-2">
          ${(c.why||[]).map(w=>`<span class="badge badge-emerald">âœ“ ${w}</span>`).join('')}
        </div>
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(140px,1fr));gap:0.6rem;font-size:0.82rem">
          <div><span style="color:var(--text-muted)">ðŸ’° Salary:</span> <strong>${c.salary||'â€”'}</strong></div>
          <div><span style="color:var(--text-muted)">ðŸŽ“ Degree:</span> <strong>${c.degree||'â€”'}</strong></div>
          <div><span style="color:var(--text-muted)">ðŸ¢ Companies:</span> <strong>${c.companies||'â€”'}</strong></div>
          <div><span style="color:var(--text-muted)">ðŸ“ˆ Growth:</span> <strong>${c.growth||'â€”'}</strong></div>
        </div>
      </div>
    `).join('')}

    <div class="flex gap-2 justify-center mt-4 wrap">
      <a href="/dashboard.html" class="btn btn-primary btn-lg">View Full Dashboard â†’</a>
